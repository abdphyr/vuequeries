import { ApiResource, VuexResouce } from "./src/resources";
...
export const defineVuexResource = (options, tokenKey, expiresIn) => new VuexResouce(options, tokenKey, expiresIn);
